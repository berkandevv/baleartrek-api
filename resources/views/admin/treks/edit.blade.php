        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4 flex justify-between items-center bg-white/90 border border-cyan-100 shadow-sm sm:rounded-2xl px-5 py-4">
                <div>
                    ...
                    <h2 class="mt-2 font-semibold text-xl text-gray-800 leading-tight">Editar excursión</h2>
                </div>
            </div>

            <div class="bg-white/90 border border-cyan-100 shadow-sm sm:rounded-2xl">
                <div class="p-6 text-slate-900">
                    <form method="POST" action="{{ route('admin.treks.update', $trek->id) }}" class="space-y-6" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
